...
def view_print(request):
    ...
    statement_path = settings.BASE_DIR / 'family_planning' / 'static' / 'json' / 'statement-data.json'
    ...
    fee_summary = _load_json(settings.BASE_DIR / 'family_planning' / 'static' / 'json' / 'fee-summary.json')
    professional_fees = _load_json(settings.BASE_DIR / 'family_planning' / 'static' / 'json' / 'professional-fees.json')
    itemized_charges = _load_json(settings.BASE_DIR / 'family_planning' / 'static' / 'json' / 'itemized-charges.json')
    ...
    template = loader.get_template('family_planning/viewPrintPDF.html')
    return HttpResponse(template.render(context, request))